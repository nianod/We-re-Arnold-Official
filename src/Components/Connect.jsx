...
const Connect = () => {
  return (
    <div className="mt-20">
        <h1 className="text-center text-2xl font-bold text-green-600">Connect with Us</h1>
        <h2 className="text-center text-[15px] font-semibold text-gray-400 mt-4">Follow, Connect & Reach to us</h2>
      ...
      {contactSites.map((contact, index) => (
        ...
        >
            <a href={contact.Url} target="_blank">
                <p className="flex justify-center flex-col items-center text-2xl">{contact.icon}
