  ...
  return (
    <div className={`mt-20 pb-30 overflow-x-hidden ${theme === 'dark' ? 'bg-[#060234]' : 'bg-white'}`}>
      ...
      <div>
        ...
        <div
          data-aos="flip-right"
          className="flex justify-center text-white gap-4 mt-4"
        >
          <Link
            to="/prices"
            className="bg-[#ff0088] px-2 rounded-xl p-[3px] font-bold cursor-pointer beet hover:scale-110 transition-transform duration-200"
          >
            EXPLORE OUR PRICING
          </Link>
          <Link
      ...
      <div className="mt-10">
        <h2 className="text-2xl text-green-500 text-center font-bold underline">
          Services
        </h2>
        <div className=" flex flex-col justify-center items-center mt-7 border-2 w-fit m-auto p-5 rounded-md box-orange-green">
          <div data-aos="zoom-in" className="content">
            ...
            <Link
              data-aos="zoom-in"
              to="services"
              className="text-white bg-blue-500 cursor-pointer p-2 px-5 rounded-2xl font-bold mt-5 flex justify-center"
            >
              Explore in Details →
            </Link>
          </div>
